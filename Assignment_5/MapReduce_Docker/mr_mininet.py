...
def parseCmdLineArgs ():
    ...
    parser.add_argument ("-p", "--masterport", type=int, default=5556, help="EnergyAvg master port number, default 5556")
...
def runMapReduceWordCount (hosts, args):
    try:
        ...
        popens [ hosts[0] ] = hosts[0].popen ('python', './mr_energy.py', '-m', str(args.map), '-r', str(args.reduce), '-p', str(args.masterport), args.datafile, stdout=subprocess.PIPE )
